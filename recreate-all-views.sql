-- Recreate all views from scratch
...
-- Step 2: Create individual_orders_clean view
...
SELECT
    ...
    CASE 
        WHEN COALESCE(o.quantity_sold, 0) > 0 THEN
...
-- Step 3: Create collection_summary_clean view
