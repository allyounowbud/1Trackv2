...
/**
 * Universal Top Search Bar Component
 * 
 * A standardized top search bar that appears consistently
 * across all pages with game selection and search functionality.
 * 
 * @param {Object} props
 * @param {boolean} props.isVisible - Whether the search bar should be visible
 * @param {Function} props.onSearch - Custom search handler
 * @param {Function} props.onGameSelect - Custom game selection handler
 */
const UniversalTopSearchBar = ({
  isVisible = true,
  onSearch,
  onGameSelect
}) => {
  ...
  const { searchQuery, setSearchQuery, selectedGame, setSelectedGame } = useGlobalHeader();
...
export default UniversalTopSearchBar;
