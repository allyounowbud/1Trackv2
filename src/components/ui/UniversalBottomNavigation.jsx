 ...
 * 
 * A standardized bottom navigation that appears consistently
 * across all pages and is hidden when bulk menu is active.
 * 
 * @param {Object} props
 * @param {boolean} props.isVisible - Whether the navigation should be visible
 * @param {string} props.variant - Navigation variant (currently only 'default')
...
const UniversalBottomNavigation = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 bg-gray-950 border-t border-gray-300 safe-bottom">
