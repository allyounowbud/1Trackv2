  ...
  async storeCard(card, game, searchQuery) {
    try {
      const cardData = {
        ...
        // Scrydex raw pricing data
        raw_condition: card.raw_pricing?.condition,
        raw_is_perfect: card.raw_pricing?.is_perfect,
        raw_is_signed: card.raw_pricing?.is_signed,
        raw_is_error: card.raw_pricing?.is_error,
        raw_low: card.raw_pricing?.low,
        raw_market: card.raw_pricing?.market,
        raw_currency: card.raw_pricing?.currency || 'USD',
        raw_trends: card.raw_pricing?.trends,
        // Scrydex graded pricing data
        graded_grade: card.graded_pricing?.grade,
        graded_company: card.graded_pricing?.company,
        graded_is_perfect: card.graded_pricing?.is_perfect,
        graded_is_signed: card.graded_pricing?.is_signed,
        graded_is_error: card.graded_pricing?.is_error,
        graded_low: card.graded_pricing?.low,
        graded_mid: card.graded_pricing?.mid,
        graded_high: card.graded_pricing?.high,
        graded_market: card.graded_pricing?.market,
        graded_currency: card.graded_pricing?.currency || 'USD',
        graded_trends: card.graded_pricing?.trends,
        // Comprehensive pricing data from PriceCharting
        bgs_10_price: card['bgs-10-price'] ? card['bgs-10-price'] / 100 : null,
        condition_17_price: card['condition-17-price'] ? card['condition-17-price'] / 100 : null,
        condition_18_price: card['condition-18-price'] ? card['condition-18-price'] / 100 : null,
        box_only_price: card['box-only-price'] ? card['box-only-price'] / 100 : null,
        cib_price: card['cib-price'] ? card['cib-price'] / 100 : null,
        loose_price: card['loose-price'] ? card['loose-price'] / 100 : null,
        new_price: card['new-price'] ? card['new-price'] / 100 : null,
        retail_new_buy: card['retail-new-buy'] ? card['retail-new-buy'] / 100 : null,
        retail_new_sell: card['retail-new-sell'] ? card['retail-new-sell'] / 100 : null,
        retail_cib_buy: card['retail-cib-buy'] ? card['retail-cib-buy'] / 100 : null,
        retail_cib_sell: card['retail-cib-sell'] ? card['retail-cib-sell'] / 100 : null,
        retail_loose_buy: card['retail-loose-buy'] ? card['retail-loose-buy'] / 100 : null,
        retail_loose_sell: card['retail-loose-sell'] ? card['retail-loose-sell'] / 100 : null,
        gamestop_price: card['gamestop-price'] ? card['gamestop-price'] / 100 : null,
        gamestop_trade_price: card['gamestop-trade-price'] ? card['gamestop-trade-price'] / 100 : null,
        raw_pricing_data: card.raw_pricing_data || null,
  ...
  async storeSealedProduct(product, game, searchQuery) {
    try {
      const productData = {
        ...
        // Comprehensive pricing data from PriceCharting
        bgs_10_price: product['bgs-10-price'] ? product['bgs-10-price'] / 100 : null,
        condition_17_price: product['condition-17-price'] ? product['condition-17-price'] / 100 : null,
        condition_18_price: product['condition-18-price'] ? product['condition-18-price'] / 100 : null,
        box_only_price: product['box-only-price'] ? product['box-only-price'] / 100 : null,
        cib_price: product['cib-price'] ? product['cib-price'] / 100 : null,
        loose_price: product['loose-price'] ? product['loose-price'] / 100 : null,
        new_price: product['new-price'] ? product['new-price'] / 100 : null,
        retail_new_buy: product['retail-new-buy'] ? product['retail-new-buy'] / 100 : null,
        retail_new_sell: product['retail-new-sell'] ? product['retail-new-sell'] / 100 : null,
        retail_cib_buy: product['retail-cib-buy'] ? product['retail-cib-buy'] / 100 : null,
        retail_cib_sell: product['retail-cib-sell'] ? product['retail-cib-sell'] / 100 : null,
        retail_loose_buy: product['retail-loose-buy'] ? product['retail-loose-buy'] / 100 : null,
        retail_loose_sell: product['retail-loose-sell'] ? product['retail-loose-sell'] / 100 : null,
        gamestop_price: product['gamestop-price'] ? product['gamestop-price'] / 100 : null,
        gamestop_trade_price: product['gamestop-trade-price'] ? product['gamestop-trade-price'] / 100 : null,
        raw_pricing_data: product.raw_pricing_data || null,
