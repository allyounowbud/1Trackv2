-- Migration to add source field to individual_orders_clean view
-- This ensures custom items are properly categorized as "Custom" instead of "Ungraded"

-- Drop and recreate the view with source field
...
-- Add comment
COMMENT ON VIEW individual_orders_clean IS 'Individual orders with order numbers, card numbers, and source for proper categorization';
